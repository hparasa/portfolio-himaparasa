...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/himaparasa19@gmail.com', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        toast.success('Thanks for reaching out! Will get back to you, or not. I\'m kidding. No, I\'m not. Teheee!', {
          position: "top-right",
          autoClose: 5000,
      ...
      <div className="container">
        ...
        <div className="flex flex-wrap gap-10">
          <div className="flex-1 min-w-[280px]">
            ...
            <p className="text-muted-foreground mt-2">If you’re working on an interesting engineering problem, I’d love to hear about it!</p>

            <div className="mt-6 space-y-4">
              <div className="flex items-center gap-3">
                <FaEnvelope className="text-primary" />
                <a href="mailto:himaparasa19@gmail.com" className="hover:text-primary transition-colors">
                  himaparasa19@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <FaLinkedin className="text-primary" />
                <a href="https://www.linkedin.com/in/hima-v-parasa/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/hima-v-parasa
                </a>
              </div>
              <div className="flex items-center gap-3">
